...
public class FavoriteMeal {
    ...
    // Constructor matching RecipeDetails structure
    public FavoriteMeal(String mealId, String mealName, String mealCategory, String mealArea,
                        String mealInstructions, String mealThumbnail, String mealTags, String mealYoutube,
                        ...
                        String mealSource, String mealImageSource) {
        this.mealId = mealId;
    ...
    public String getMealImageSource() {
        return mealImageSource;
    }

    public void setMealImageSource(String mealImageSource) {
        this.mealImageSource = mealImageSource;
    }

    // Helper method to create FavoriteMeal from RecipeDetails
    public static FavoriteMeal fromRecipeDetails(com.example.foodplanner.data.model.recipe_details.RecipeDetails recipe) {
        return new FavoriteMeal(
                recipe.getIdMeal(),
                recipe.getMealName(),
                recipe.getMealCategory(),
                recipe.getMealArea(),
                recipe.getMealInstructions(),
                recipe.getStrMealThumbnail(),
                recipe.getStrTags(),
